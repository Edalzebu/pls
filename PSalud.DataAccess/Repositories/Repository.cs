...
using PSalud.Entities.Repositories;
using NHibernate;
using NHibernate.Linq;

namespace PSalud.DataAccess.Repositories
{
    public class Repository : IIntKeyedRepository
    {
        ...
        public bool Add<T>(System.Collections.Generic.IEnumerable<T> items) where T : class
        {
        ...
        public bool Delete<T>(System.Collections.Generic.IEnumerable<T> entities) where T : class
        {
